...
\thispagestyle{empty}
\begin{abstract}
This report contains solutions for the problems described in Assignment L3 for the course VLSI Programming. We will transform a parallel FIR filter to a sequential one to reduce hardware utilization. We will create a strength reduced version of this filter.
\end{abstract}
